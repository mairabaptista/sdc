...
class Network(nn.Module):
    ...
    def __init__(self, input_size, nb_action):
        ...
        self.fcOut = nn.Linear(50, nb_action)
    ...
    def forward(self, state):
        ...
        l10 = F.relu(self.fc10(l9))
        q_values = self.fcOut(l10)
        return q_values
...
class Dqn():
    ...
    def learn(self, batch_state, batch_next_state, batch_reward, batch_action):
        ...
        x = td_loss
        self.loss_averages.append(x.data[0])
        if len(self.loss_averages) > 1000:
            del self.loss_averages[0]       
    ...
    def update(self, reward, new_signal):
        ...
        return action, self.loss_averages
